...
public class PersonalTest {
    ...
    public void TestPersonal() throws Exception {
        ...
        PersonalFate person = new PersonalFate(LocalDateTime.of(1985, 9, 11, 5, 50, 0), true, false);
        PersonalFate person8 = new PersonalFate(LocalDateTime.of(1985, 9, 11, 5, 50, 0), true, true);
